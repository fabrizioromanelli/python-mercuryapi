...
static const char *regions[] = {"UNSPEC", "NA", "EU", "KR", "IN", "JP", "PRC",
                                "EU2", "EU3", "KR2"};
static const char *powerModes[] = {"FULL", "MINSAVE", "MEDSAVE", "MAXSAVE"};
...
static const char *gen2LinkFrequencyNames[] = {"250kHz", "300kHz", "400kHz", "40kHz"};
    ...
    case TMR_TAGOP_GEN2_READDATA:
      printf("Gen2.Read:%s,%d,%d",
             listname(bankNames, numberof(bankNames),
                      tagop->u.gen2_readData.bank),
             tagop->u.gen2_readData.wordAddress,
             tagop->u.gen2_readData.len);
      break;
